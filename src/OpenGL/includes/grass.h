...
public:
	...
	// Constructor
	Grass(glm::vec3 position = glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3 rotation = glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3 scaler = glm::vec3(1.0f, 1.0f, 1.0f))
	{
		Position = position;
		Rotation = rotation;
		Scaler = scaler;
	...
	void Draw(Shader program, glm::mat4 view_matrix, glm::mat4 projection_matrix)
	{
		...
		// material properties
		program.setFloat("material.shininess", 30.0f);
